<?php
session_start();
$registrationError = $_SESSION['error_message'] ?? '';
...
<head>
    ...
    <title>Register | Household Shopping Manager</title>
                            ...
                            <div class="row gy-3 gy-md-4 overflow-hidden">
                                ...
                                <div class="col-12">
                                    ...
                                    <input
                                        ...
                                        pattern="[+]?[0-9]{10,14}"
                                        title="Phone number should be 10-14 digits, can include a + at the start"
                                        required
